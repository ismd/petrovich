...
<div class="carousel carousel--type-inline carousel--background-yes">
    <div class="layout layout--width-small">
        <h2 class="carousel__title">Мы помогаем</h2>

        <div class="carousel__title-text">Не&nbsp;обязательно быть школой или детским домом, чтобы мы&nbsp;помогли. Важно просто быть хорошими людьми, которым нужна поддержка</div>
