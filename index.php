                ...
                <div class="vacancy-slider__select-block">
                    ...
                    <div class="vacancy-slider__center">
                        ...
                        <div class="vacancy-slider__pages">
                            <a href="javascript:void(0)"
                               class="js-vacancy-slider-page vacancy-slider__page vacancy-slider__page--state-active">Офис</a>
                            <a href="javascript:void(0)"
                               class="js-vacancy-slider-page vacancy-slider__page">Склад</a>
                            <a href="javascript:void(0)"
                               class="js-vacancy-slider-page vacancy-slider__page">Магазин</a>
                            <a href="javascript:void(0)"
                               class="js-vacancy-slider-page vacancy-slider__page">Студентам</a>
                        </div>
                    </div>
                </div>
